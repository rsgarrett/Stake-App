...
echo.
echo IMPORTANT: Use the Personal Access Token as the password!
echo.
pause
echo.
...
if %errorlevel% equ 0 (
    ...
    echo.
    echo Common issues:
    echo   1. Make sure you used the Personal Access Token, not the password
    echo   2. Make sure the token has "repo" scope checked
